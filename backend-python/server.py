...
CORS(
    ...
    origins=["https://leitor.itaguai.rj.gov.br:5000"]
)
...
def start_biometric_thread():
    ...
    t = threading.Thread(target=identify_forever, args=(socketio,), daemon=True)
    t.start()
...
if __name__ == '__main__':
    ...
    socketio.run(app, debug=True, host='0.0.0.0', port=5000, certfile=cert_path, keyfile=key_path)
