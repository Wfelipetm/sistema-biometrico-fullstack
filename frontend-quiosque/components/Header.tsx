...
import logoLight from '../public/images/SMCTIC - Branco.png';
...
export default function Header({ logoMarginLeft, className }: HeaderProps) {
	...
	return (
		<header className={cn("sticky top-0 z-10 flex h-32 items-center gap-4 border-b px-4 md:px-6 bg-gradient-to-l from-blue-50 via-white to-white", className)}>
			{/* Centro: logo */}
